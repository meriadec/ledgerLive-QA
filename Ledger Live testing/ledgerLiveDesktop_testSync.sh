...
rm ~/Workspace/repos/ledgerLive-QA/Ledger\ Live\ testing/app_synced.json
...
cp ~/Workspace/repos/ledgerLive-QA/Ledger\ Live\ testing/app.json ~/Library/Application\ Support/Ledger\ Live
...
cp ~/Library/Application\ Support/Ledger\ Live/app.json ~/Workspace/repos/ledgerLive-QA/Ledger\ Live\ testing/app_synced.json
